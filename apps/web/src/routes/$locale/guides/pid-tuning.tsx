...
export const Route = createFileRoute('/$locale/guides/pid-tuning')({
  component: PidGuidePage,
});

function PidGuidePage() {
  const t = useT();
  return (
    <div className="animate-fade-in">
      <h1 className="text-2xl font-extrabold">{t.nav.pidGuide}</h1>
