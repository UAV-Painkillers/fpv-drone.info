...
export function FlightLogIndex(logData) {
  ...
  function buildLogOffsetsIndex() {
    var stream = new ArrayDataStream(logData),
      i,
      logStart;
  ...
  function buildIntraframeDirectories() {
    var parser = new FlightLogParser(logData, that);
            ...
            case "I":
              ...
              if (frameType == "I") {
                ...
                if (iframeCount % 4 === 0) {
                  ...
                  intraIndex.initialTimeRolloverAccumulator.push(
                    frameTime -
                      (frameTime >>>
                        0) /* i.e. frameTime with the lower 32-bits masked out */
                  );
  ...
  this.saveToJSON = function () {
    var intraframeDirectories = this.getIntraframeDirectories(),
      i,
      j,
