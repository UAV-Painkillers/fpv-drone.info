...
import { FIRMWARE_TYPE_BETAFLIGHT } from "./firmware_types";
 ...
 * @returns {Number}
 */
export function memmem(haystack, needle, startIndex) {
  for (
...
export function formatTime(msec, displayMsec) {
  // modify export function to allow negative times.
...
export function adjustFieldDefsList(firmwareType, firmwareVersion) {
  if (
    ...
    semverGTE(firmwareVersion, "3.3.0")
  ) {
