...
import { HilltopAdsScript } from "./hilltop-ads";
  ...
  return (
    <>
      ...
      <link
        ...
        sizes="180x180"
        href="/pwa/apple-touch-icon.png?v=13"
      />
      <link
        rel="icon"
        type="image/png"
        sizes="32x32"
        href="/pwa/favicon-32x32.png?v=13"
      />
      <link
        rel="icon"
        type="image/png"
        sizes="16x16"
        href="/pwa/favicon-16x16.png?v=13"
      />
      <link rel="manifest" href="/pwa/site.webmanifest?v=13" />
      <link rel="mask-icon" href="/pwa/safari-pinned-tab.svg?v=13" />
